...
section .data
index: equ 5
msg: db "%2$cmacro systemcall 1%1$cmov rdi, %2$c1%1$ccall _system%1$c%2$cendmacro%1$c%2$cmacro opencall 1%1$cmov rdi,%2$c1%1$cmov rsi,03001o%1$cmov rdx,0644o%1$cmov rax,0x2000005%1$csyscall%1$cjc .end%1$c%2$cendmacro%1$c%2$cmacro closecall 1%1$cmov rdi,%2$c1%1$cmov rax,0x2000006%1$csyscall%1$c%2$cendmacro%1$c%2$cmacro sprintfcall 3%1$cmov rdi,%2$c1%1$cmov rsi,%2$c2%1$cmov rdx,%2$c3%1$ccall _sprintf%1$c%2$cendmacro%1$c%1$cglobal start%1$cglobal _main%1$cextern _dprintf%1$cextern _sprintf%1$cextern _system%1$c%1$cstart:%1$ccall _main%1$cret%1$c%1$c_main:%1$cpush rbp%1$cmov rbp,rsp%1$cmov qword[rsp],index%1$cmov rdi,Sully_5%1$cmov rsi,0%1$cmov rax,0x2000005%1$csyscall%1$cjc .sully%1$cdec qword[rsp]%1$c.sully:%1$csprintfcall filename,filename_format,qword[rsp]%1$copencall filename%1$cmov rdi,rax%1$clea rsi,[rel msg]%1$cmov rdx,10%1$cmov rcx,37%1$clea r8,[rel msg]%1$cmov r9,34%1$ccall _dprintf%1$csprintfcall cmd,compil_format,qword[rsp]%1$csystemcall cmd%1$ccmp qword[rsp],0%1$cjle .end%1$csprintfcall cmd,exec_format,qword[rsp]%1$csystemcall cmd%1$c.end:%1$cclosecall rdi%1$cpop rbp%1$cmov rax,0%1$cret%1$c%1$csection .data%1$cindex: equ %5$d%1$cmsg: db %4$c%3$s%4$c,0%1$cfilename_format: db %4$cSully_%2$cd.s%4$c,0%1$ccompil_format: db %4$cnasm -f macho64 Sully_%2$c1$d.s -o Sully_%2$c1$d.o && ld -macosx_version_min 10.8 -lSystem Sully_%2$c1$d.o -o Sully_%2$c1$d%4$c,0%1$cexec_format: db %4$c./Sully_%2$cd%4$c,0%1$cSully_5: db %4$cSully_5.s%4$c%1$csection .bss%1$cfilename: resb 10%1$ccmd: resb 100%1$c",0
